                        ...
                        <div class="row">
                            <div class="col-12 col-md-3"
                                ...
                                <div class="form-group" style="margin-bottom: unset">
                                    ...
                                    <date-picker v-else-if="filter.type==='datepicker'" v-model:value="filter.value" :placeholder="filter.title"
                                                 format="DD-MM-YYYY" value-type="format"></date-picker>
                                    <date-picker v-else-if="filter.type==='rangepicker'" v-model:value="filter.value"
                                                 :placeholder="filter.title" format="DD-MM-YYYY" range value-type="format"></date-picker>
                                </div>
                            </div>
