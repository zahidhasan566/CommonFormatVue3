<template>
    <div class="layout-px-spacing">
        ...
        <div class="layout-px-spacing">
            <div class="row main-notes layout-top-spacing layout-spacing" id="cancel-row">
                <div class="col-lg-12">
                    ...
                    <div class="main-container">
                        <div class="main-note-container">
                            <div class="main-note-overlay" :class="{ 'main-note-overlay-show': is_show_note_menu }" @click="is_show_note_menu = false"></div>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="ddlMore">
                                                    <li>
                                                        <a
                                                            ...
                                                            @click="set_tag(note, 'personal')"
                                                            >Personal</a
                                                        >
                                                    </li>
                                                    <li>
                                                        <a href="javascript:;" class="dropdown-item note-work label-group-item label-work position-relative g-dot-work" @click="set_tag(note, 'work')"
                                                            >Work</a
                                                        >
                                                    </li>
                                                    <li>
