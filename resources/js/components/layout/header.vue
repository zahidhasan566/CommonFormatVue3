            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center">
                    <li class="nav-item theme-logo">
                        <router-link to="/">
                            <span><img :src="`${mainOrigin}/images/logo.png`" alt="" height="80%" /> </span>
                        </router-link>
                    </li>
                    <li class="nav-item theme-text">
                        <router-link to="/" class="nav-link">Group Expense</router-link>
                    </li>
                </ul>
...
const logout = () => {
    console.log('Logging out...');  // Add log to confirm the function is being called

    axiosPost("logout", {}, (response) => {
            ...
            successNoti(response.message); // Show success notification
        },
        (error) => {
            console.log('Error:', error);  // Log any errors during the request
            errorNoti(error);
        });
};
