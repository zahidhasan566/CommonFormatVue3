<template>
    <div>
        ...
        <div class="main-settings" :class="{ active: isOpen }">
            ...
            <perfect-scrollbar class="sidbarchat p-3" tag="div">
                ...
                <p class="small text-muted mb-3">Select the primary navigation paradigm for your main.</p>
                <div class="btn-group-toggle row mb-4 mx-0">
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                ...
                <p class="small text-muted mb-3">Select the primary Layout Style for your main.</p>
